...
- [ ] **Phase 13 — Frontend Cleanup**: Two bug fixes, four JS structural improvements, one HTML validity fix, four CSS cleanup items. No behavior changes except B1. Frontend-only.
